...
B1-B067/068/069/070 allocate four CAN resistors, one RS-485 resistor, two jumper headers and two shunts. B1-B007/023 retain only residual protection/control/bias. Exact resistor and jumper MPNs remain unselected; [candidate parts](../../boards/board1/termination_parts.md) are recommendations, not accepted selections.
