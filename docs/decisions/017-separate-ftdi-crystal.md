...
superseded_by: ADR-030 (provisional FTDI MPN status only)
...
Evidence and dated DigiKey sourcing: [crystal candidates](https://github.com/ofdouglas/ws-hardware/blob/dbcaba10831ade0516dba825d2c97d3f0017e0f5/boards/board1/crystal_candidates.md#separate-ft232hl-candidate--usr-22). B1-Q008 remains open for exact loading, drive/startup, temperature/lifetime and FTDI current-document reconciliation. B1-Q005 retains footprint review. A selected candidate and arithmetic margin do not establish hardware validation.
