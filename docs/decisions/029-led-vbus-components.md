...
Accept CSL1901DW1 for four MCU LEDs plus the main-power LED, CL21A475KBQNNNE for B046 (4.7 uF, 50 V, X5R, +/-10%, 0805), and SG73P2BTTD1R0J for B047 (1 ohm, +/-5%, pulse-rated, 1206). X5R replaces X7R for B046 only; 5% replaces 1% for B047. The LED's 0603 body is accepted. Sources and exact allocation are in bom.csv and passive_review.md.
