...
470/680 ohm do not meet the +200 mV threshold with both terminators. 390 ohm leaves little tolerance-screen margin. Recommend evaluating 330 ohm 1% first: about 45 mV remains at the stated corner, before other error sources. This is not a guaranteed all-corners design. A 1 mA adverse differential current through approximately 55 ohm could consume 55 mV; quantify actual receiver/protection leakage rather than dismissing it. Include remote resistor tolerance and voltage drop along the cable when checking the remote end.
...
B1-Q009 remains open for remote hardware identification, bias ownership, worst-case leakage/temperature, driver loading, cable/common-mode and power-off behavior. Verify idle A-B and RO, both transmit polarities and frame turnaround with both terminations fitted. Exact bias MPNs remain TBD; no schematic, ERC/DRC or bench validation was performed.

[TVS candidates](tvs_candidates.md) document transient-clamp compatibility and added bus capacitance under B1-Q009.
