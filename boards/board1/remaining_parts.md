...
Complete schematic capture has enumerated all components, connectors and support networks. [CSV](bom_internal.csv) owns quantities/MPNs; [CAD notes](kicad/README.md) describe 239 objects / 879 pins and checks. No fitted-component count or connectivity choice remains TBD. B007/B010/B017 are zero residual aggregates; B023/B060 are actual default resistors; B075 is six dedicated two-post ground headers. B084 is seven communications headers; B011 retains twelve rail/reset/boot/core copper pads.
