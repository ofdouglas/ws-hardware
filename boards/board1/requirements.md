...
|---|---|---|---|---:|---|
| B1-N01 | GW | Gateway | STM32G473RBT6 | 1 | ADR-043 maintainer correction |
...
| B1-R008 | MVP | accepted | Expose twelve rail/reset/boot/core pads, six fitted ground headers and seven 1x2 0.1-inch communications headers: CAN A H/L, CAN B H/L, RS-485 A/B, each directed SAM ring hop signal/GND, and UART_MD signal/GND; provide concise functional silkscreen and local ground access | Schematic/layout accessibility, pin order and labeling review; probe access at bring-up | USR-33/38; ADR-039/046; B1-Q004 |
...
| B1-Q004 | open | Board designer | Define external bus access, connector pinouts, grounding/protection, debug/reset headers, test points and mechanical constraints | Connector allocation and layout | Connector numbering, twelve copper testpads, seven communications measurement headers and six ground headers are captured and approximately placed on the native PCB under ADR-046. Initial placement has no component collisions; see [placement checks](kicad/placement.md). Actual mating, final clip/mechanical clearance, SWD internal pad-clearance rule disposition and detailed placement/routing remain. |
...
ADR-026 retains connector MPN selections. ADR-041 / USR-35 replaces the separate GPIO/debug headers with four combined 1x8 timing/debug headers. One selected 40-position strip supplies all 32 positions. General ADC, SPI/I2C and GPIO breakouts are deferred. Resistor selections and fitted scope-ground access from ADR-039 remain in force; ADR-046 replaces communications copper pads with seven headers while retaining twelve rail/reset/boot/core pads. Timing MCU pads and six ground-header assemblies are captured; electrical and physical placement checks remain under B1-Q004/005/010. B1-Q004/005 retain terminal numbering, footprints, SWD cable/key and adapter checks. See [timing headers](timing_headers.md).
...
ADR-041 / USR-35 replaces the separate GPIO/debug headers with four combined 1x8 timing/debug headers. One selected 40-position strip supplies all 32 positions. General ADC, SPI/I2C and GPIO breakouts are deferred. Resistor selections and fitted scope-ground access from ADR-039 remain in force; ADR-046 replaces communications copper pads with seven headers while retaining twelve rail/reset/boot/core pads. Timing MCU pads and six ground-header assemblies are captured; electrical and physical placement checks remain under B1-Q004/005/010.
...
Historical initial full-schematic completion (2026-09-07): eleven native sheets and 872 pins passed the then-current netlist checks, with a 208 MCU-pad comparison. ADR-046 adds communications headers, bringing current connectivity to 879 pins; see current CAD checks. Conventional defaults are fully enumerated; no new architecture or maintainer acceptance claimed. B1-Q002–012/014 retain their approval/bring-up portions.

Gateway correction: [ADR-043](../../docs/decisions/043-gateway-part-correction.md) supersedes ADR-004 for B1-N01/B1-B001 only. Native G473 symbol and BOM now agree; G474-specific prior evidence and workbook/PDF snapshots do not verify G473. B1-Q005/008 retain exact G473 pinmux/electrical/errata review before schematic approval.

[ADR-044](../../docs/decisions/044-yageo-crystal-load-capacitors.md) records the maintainer-selected YAGEO 33 pF MPN for B1-B042/043 under B1-R015. Values/counts/footprints remain unchanged; B1-Q008 retains oscillator qualification.

[ADR-045](../../docs/decisions/045-yageo-27pf-crystal-capacitors.md) selects YAGEO CC0805FRNPO9BN270 for the two B1-B058 FTDI load capacitors. Existing initial values and B1-Q008 qualification remain.

[ADR-046](../../docs/decisions/046-communications-measurement-headers.md) / USR-38 replaces communications copper pads with J19–J25, including all three UART-ring hops; exact pin order is in [pinmap](pinmap.md#communications-measurement-access). TP13–TP19 are retired, twelve copper pads and six ground headers retained. B1-Q004 retains final clip clearance, silkscreen and routed branch review.
