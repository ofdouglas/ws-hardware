...
| B1-R020 | Rev A GPIO | accepted | Provide a few spare I/O pins per MCU on breakouts | Full pinmux audit and electrical/load contract; count TBD | USR-06; ADR-007; B1-Q010 |
...
| B1-R023 | Main buck efficiency | accepted | Support conservative full networking load within 500 mA total USB current; no fixed 90% or light-load efficiency target | Full-load USB current and startup measurements; approx 70.6% steady-state break-even under current assumptions | ADR-021 |
...
| B1-Q011 | open | Power designer | Qualify converter efficiency envelope, passives, layout and losses | Main power design approval | USR-13 limits efficiency qualification to full networking load; see sc189_decoupling.md; temperature/full-load corners and measurements pending |
