...
Topology sources: [TI RS-485 termination guidance SSZTB23A](https://www.ti.com/lit/ta/ssztb23a/ssztb23a.pdf), [TI CAN guide SLLU342](https://www.ti.com/lit/pdf/sllu342). Original [topology note](termination_proposal.md) and [parts research](termination_parts.md) retain provenance and dated price/stock snapshots. Refresh DigiKey availability at procurement. No ERC/DRC or waveform validation is asserted.
