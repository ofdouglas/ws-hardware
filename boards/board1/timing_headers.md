...
Captured assignment: GW SYNC/TRIG=PC0/PC1 pads8/9 (EXTI0/1), EVENT0/1=PC2/PC3 pads10/11. SAM SYNC/TRIG=PA02/PA03 pads3/4 (EXTINT2/3,muxA), EVENT0/1=PB08/PB09 pads7/8. Distinct interrupt lines and existing UART/CAN mappings were checked. See corrected pinmap/workbook; evidence remains unverified pending approval. No precision skew or timer-capture requirement is inferred.

Before layout approval, check cut-strip footprints, pin-1 marking and scope access. The two GND posts provide probe-ground clip locations; B1-B075 supplies six dedicated two-post ground headers for local clip access, separately from timing headers. Keep short local probe return paths for edge measurements. Unallocated strip posts are not counted as fitted ground pins. B1-Q010/014 retain external-drive, load and unpowered-interface review. At bring-up, exercise shared stimuli and observe each MCU's private event outputs.
...
Captured bench contract: connect3.3V external sources only after3V3_SYS is on, and disconnect/disable before USB power-off or suspend. Do not leave a powered debug adapter driving an unpowered MCU. Debug RX has a10k main-domain idle pull-up on the MCU side of its330ohm resistor. No automatic power-off buffer is fitted.
