...
<!-- Generated by scripts/board1_documents.py; edit bom_internal.csv, bom_quantity_rules.json or bom_allocation_notes.md. -->

Status: planning BOM; selected baseline through ADR-042. [CSV](bom_internal.csv) owns parts and evidence. [Quantity rules](bom_quantity_rules.json) distinguish purchased source stock from placed pieces. Unknown counts stay TBD. All sourcing is through DigiKey; refresh order codes/stock before purchase. Acceptance is not electrical verification or an ordering release.

## Accepted selections

| ID | Buy qty | Place qty | Function | MPN | Value / package | Quantity basis | Evidence | Authority |
|---|---:|---:|---|---|---|---|---|---|
| B1-B001 | 1 | 1 | Gateway MCU | STM32G473RBT6 | NA; LQFP64 (source; verify) | components; planning allocation | unverified | ADR-004; ADR-043 |
...
| B1-B006 | 1 | 1 | VBUS TVS | SMF6.0A | Unidirectional TVS; 6 V standoff; 200 W (10/1000 us); SOD-123FL | components; planning allocation | unverified | ADR-019; ADR-022; ADR-024 |
...
| B1-B011 | 0 | 12 | PCB test pads; no purchased components | NA | 2 mm exposed copper test pad; 12 placements; PCB copper pads | PCB pads; no purchased part | unverified | ADR-039; ADR-046 |
...
| B1-B042 | 2 | 2 | Gateway crystal load capacitors | CC0805FRNPO9BN330 | 33 pF +/-1%; 50 V C0G; 0805 | components; planning allocation | unverified | ADR-005; ADR-014; ADR-031; ADR-044 |
| B1-B043 | 6 | 6 | Three SAM crystal load capacitors (two per MCU) | CC0805FRNPO9BN330 | 33 pF +/-1%; 50 V C0G; 0805 | components; planning allocation | unverified | ADR-005; ADR-014; ADR-031; ADR-044 |
...
| B1-B058 | 2 | 2 | FTDI crystal load capacitors | CC0805FRNPO9BN270 | 27 pF +/-1%; 50 V C0G; 0805 | components; planning allocation | unverified | ADR-031; ADR-045 |
| B1-B059 | 0 | 4 | Per-MCU combined timing/debug headers | PH1-08-UA | 1x8; 2.54 mm; Through-hole; 1x8 discrete male header; 2.54 mm pitch | four 1x8 timing/debug sections included in B1-B027 | unverified | ADR-032; ADR-039; ADR-041; ADR-042 |
...
| B1-B084 | 7 | 7 | Communications measurement headers | PRPC002SAAN-RC | 2 positions; gold flash; Through-hole; 1x2; 2.54 mm | components; planning allocation | unverified | ADR-046 |
...
| ID | Buy qty | Place qty | Function | MPN | Value / package | Quantity basis | Evidence | Authority |
|---|---:|---:|---|---|---|---|---|---|
| B1-B027 | 0 | 0 | Superseded timing/debug header source strip; historical allocation only | PRPC040SAAN-RC | 40 positions; 32 allocated; Through-hole; 1 x 40 breakaway male strip; 2.54 mm pitch; cut lengths/footprints TBD | excluded | unverified | ADR-007; ADR-026 (026-reva-connectors.md); ADR-039; ADR-041; ADR-042 |
