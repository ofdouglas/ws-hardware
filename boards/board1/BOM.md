...
| B1-B027 | 1 | 4 | Source strip for GPIO and debug UART headers | PRPC040SAAN-RC | 40-position strip; 32 positions allocated; Through-hole; 1 x 40 breakaway male strip; 2.54 mm pitch; cut lengths/footprints TBD | one 40-position strip; four 1x5 GPIO sections; also supplies B1-B059 | unverified | ADR-007; ADR-026 (026-reva-connectors.md); ADR-039 |
...
| B1-B053 | TBD | TBD | Gateway CBUS reset and BOOT0 interfaces | TBD | TBD; TBD | components; planning allocation | unverified | ADR-023 |
...
| B1-B059 | 0 | 4 | Per-MCU text debug UART headers | PRPC040SAAN-RC | Four placement pieces; included in B1-B027 strip; Cut 1x3 sections; 2.54 mm; through-hole | four 1x3 debug sections included in B1-B027 | unverified | ADR-032; ADR-039 |
